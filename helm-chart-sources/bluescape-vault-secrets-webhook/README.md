...
```bash
$ helm repo add bluescape https://bluescape.github.io/helm-charts
$ helm repo update
```

```bash
$ helm upgrade --namespace vswh --install vswh bluescape/bluescape-vault-secrets-webhook --create-namespace
```
...
```bash
$ helm upgrade --namespace vswh --install vswh bluescape/bluescape-web-secrets --set-string securityContext.runAsUser="" --create-namespace
```
